            ...
            <header className="sticky top-0 z-50">
                <div className="">
                    <div
                        ...
                        <Link className="inline-flex items-center gap-3 px-3 text-2xl font-semibold text-dark dark:text-white" href="/">
                            <svg
                        ...
                        <ul className="hidden flex-1 flex-wrap items-center justify-center lg:flex">
                            ...
                            <li className={`${pathName == "/about" ? "active" : ""} group/menu-item`}>
                                <Link href="/about" className='group inline-flex items-center gap-2 rounded-lg px-3 py-2 text-center text-base font-medium text-muted transition hover:bg-light hover:text-dark group-[.active]/menu-item:bg-light group-[.active]/menu-item:text-dark dark:hover:bg-dark-2 dark:hover:text-white dark:group-[.active]/menu-item:bg-dark-2 dark:group-[.active]/menu-item:text-white'>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20"
                                        fill="none"
                            ...
                            <li className={`${pathName == "/services" ? "active" : ""} group/menu-item`}>
                                <Link href="services" className='group inline-flex items-center gap-2 rounded-lg px-3 py-2 text-center text-base font-medium text-muted transition hover:bg-light hover:text-dark group-[.active]/menu-item:bg-light group-[.active]/menu-item:text-dark dark:hover:bg-dark-2 dark:hover:text-white dark:group-[.active]/menu-item:bg-dark-2 dark:group-[.active]/menu-item:text-white'>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20"
                                        fill="none"
                            ...
                            <li className={`${pathName == "/portfolio" ? "active" : ""} group/menu-item`}>
                                <Link href="/portfolio" className='group inline-flex items-center gap-2 rounded-lg px-3 py-2 text-center text-base font-medium text-muted transition hover:bg-light hover:text-dark group-[.active]/menu-item:bg-light group-[.active]/menu-item:text-dark dark:hover:bg-dark-2 dark:hover:text-white dark:group-[.active]/menu-item:bg-dark-2 dark:group-[.active]/menu-item:text-white'>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20"
                                        fill="none"
                        ...
                        <div className="hidden items-center gap-4 lg:flex">
                            <div className="">
                                {!darkMode ? (
                                    <button type="button"
                                        className="hs-dark-mode group flex h-10 w-10 items-center justify-center rounded-lg text-center font-medium text-dark transition hover:bg-light  dark:text-gray-400 dark:hover:text-gray-500"
                                    ...
                                    <button type="button" className="hs-dark-mode flex group h-10 w-10 items-center justify-center rounded-lg text-center font-medium text-dark transition hover:bg-light hs-dark-mode-active:flex dark:text-[#FD7E41] dark:hover:bg-dark dark:hover:text-[#FD7E41]"
                                        onClick={toggleDarkMode}>
                            ...
                            <a
                                href="Razib_hossain_resume_v3.1.pdf"

                    ...
                    {currentRecords.map((item) => (
                        <div key={item.id} className="">
                            <div className="relative">
                                <Link href={`blogs/${item.id}`} className="group block aspect-6/4 overflow-hidden rounded-lg">
                                    <img src={item.imgUrl} alt="blog" className="h-full w-full rounded-lg object-cover transition duration-700 group-hover:scale-105" />
                                </Link>
                            ...
                            <div className="mt-6">
                                <h2 className="text-xl font-medium xl:text-2xl">
                                    <Link href={`blogs/${item.id}`} className="inline-block text-dark transition hover:text-primary dark:text-light/70 dark:hover:text-primary">
                                        {item.title}
                                    </Link>
                                </h2>
